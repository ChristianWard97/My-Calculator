...
it('should find the element of the header', ()=>{
  render(<App />);
  const headingElement = screen.getByRole
  ('heading', {name:'My Calculator'});
...
it ('should display 3 when the users enters 6 / 2',()=>{
render (<App/>)
...
it ('should display 6 when the users enters 3*2',()=>{
  render (<App/>)
